...
•	Enable SSH
o	Navigate to the boot directory of SD card 
o	Create an empty file called SSH
o	Insert card onto the PI and power on
...
•	We can use nmap to scan our local network to find the devices that are 
connected
